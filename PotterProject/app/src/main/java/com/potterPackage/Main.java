...
public class Main extends AppCompatActivity {
    ...
    protected void onResume(){
        ...
        sensorManager.registerListener(listener, sensorLinAccel, SensorManager.SENSOR_DELAY_GAME);
        sensorManager.registerListener(listener, sensorGravity, SensorManager.SENSOR_DELAY_GAME);
         timer = new Timer();
